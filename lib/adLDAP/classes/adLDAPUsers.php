...
*/
        $add["userAccountControl"][0] = $this->accountControl($attributes['control_options']);
    ...
    */
    public function modify($username, $attributes, $isGUID = false)
    {
        ...
        */
        $mod["userAccountControl"][0] = $this->accountControl($attributes['control_options']);
